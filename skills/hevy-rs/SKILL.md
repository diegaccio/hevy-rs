...
- Read the applicable resource reference for the command:
  ...
  - Workouts, routines, exercise templates, routine folders, exercise history, and body measurements: their focused references are added alongside those resource commands.
